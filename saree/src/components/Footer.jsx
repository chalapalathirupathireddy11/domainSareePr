                ...
                <div className="container pt-md-4">
                    <div className="row footer-top-29">
                        <div className="col-lg-4 col-md-6 footer-list-29">
                            ...
                            <p className="mb-2 pe-xl-5">Address : Course Teck, 10001, 5th Avenue, #06 lane street, IND - 10017.
                            </p>
                            <p className="mb-2">Phone Number : <a href="tel:+1(21) 234 4567">+91(91) 673 4587</a></p>
                            <p className="mb-2">Email : <a href="mailto:info@eazyschool.com">info@sareesapp.com</a></p>
                        </div>
                    ...
                    copyright
                <p className="copy-footer-29 text-center pt-lg-2 mt-5 pb-2">© 2025 Sarees App. All rights reserved. Design
