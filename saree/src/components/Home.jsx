    ...
    <div>
        ...
        <div class="w3l-grids-block-5 py-5">
            <div class="container py-md-5 py-4">
                ...
                >
                    <p class="text-uppercase">Best Sarees</p>
                    ...
                    <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                        <div class="coursecard-single">
                            <div class="grids5-info position-relative">
                                ...
                                <div class="meta-list">
                                    <a href='/brand' class="sec-2">Brands</a>
                                </div>
                            </div>
                            <div class="content-main-top">
                                <div class="content-top mb-4 mt-3">
                                    <ul class="list-unstyled d-flex align-items-center justify-content-between">
                                        <li> <i class="fas fa-book-open"></i> 72 Brands</li>
                                        <li> <i class="fas fa-star"></i> 4.6</li>
                                    </ul>
                                </div>
                                <h4><a>Best Brand Sarees</a></h4>
                                <p>Special focusing the Brands  to encourage Customers
                                    from early age.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                        <div class="coursecard-single">
                            <div class="grids5-info position-relative">
                                ...
                                <div class="meta-list">
                                    <a href='/type' class="sec-3">Types</a>
                                </div>
                            </div>
                            <div class="content-main-top">
                                <div class="content-top mb-4 mt-3">
                                    <ul class="list-unstyled d-flex align-items-center justify-content-between">
                                        <li> <i class="fas fa-book-open"></i> 14 Types</li>
                                        <li> <i class="fas fa-star"></i> 5.0</li>
                                    </ul>
                                </div>
                                <h4><a>Types in a Week</a></h4>
                                <p>  encouraging the Customers on the 
                                    by Types of Sarees.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-4">
                        <div class="coursecard-single">
                            ...
                            <div class="content-main-top">
                                <div class="content-top mb-4 mt-3">
                                    <ul class="list-unstyled d-flex align-items-center justify-content-between">
                                        <li> <i class="fas fa-book-open"></i> 23 Styles</li>
                                        <li> <i class="fas fa-star"></i> 5.0</li>
                                    </ul>
                                </div>
                                <h4><a>Featurs of Styles</a></h4>
                                <p>Special development  for special needs Customers to improve their trust.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-4">
                        <div class="coursecard-single">
                            <div class="grids5-info position-relative">
                                ...
                                <div class="meta-list">
                                    <a href='/Ethinic' class="sec-2"> Wave Method</a>
                                </div>
                            </div>
                            <div class="content-main-top">
                                <div class="content-top mb-4 mt-3">
                                    <ul class="list-unstyled d-flex align-items-center justify-content-between">
                                        <li> <i class="fas fa-book-open"></i> 40 Wave Method</li>
                                        <li> <i class="fas fa-star"></i> 4.6</li>
                                    </ul>
                                </div>
                                <h4><a href="courses.html">Best Waving Methods</a></h4>
                                <p>Methods dedicated  for the Customers interested .</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-4">
                        <div class="coursecard-single">
                            ...
                            <div class="content-main-top">
                                ...
                                <h4><a to="/design">Painting Programs</a></h4>
                                <p>Art & Design  for the Customers to requires their styles.</p>
                            </div>
                        </div>
                    </div>
                </div>
